...
def GetTime(ascale, OmegaM=0.3175,OmegaL=0.6825,h=0.6711):
	"""
...
def GetLookBackTime(ascale, OmegaM=0.3175,OmegaL=0.6825,h=0.6711):
	"""
...
def CoolingRate_cgs(coor, h=0.6711):
        """
...
def hubble_function(ascale,OmegaM=0.3175,OmegaL=0.6825):
        """
